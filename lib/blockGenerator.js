...
function BlockGenerator(server, prover) {
  ...
  this.nextBlock = (manualValues) => generateNextBlock(new NextBlockGenerator(mainContext, conf, dal, logger, Certification), manualValues);
 ...
 * @constructor
 */
function NextBlockGenerator(mainContext, conf, dal, logger, Certification) {
